        ...
        E: Engine,
{
            ...
            G: PrimeCurveAffine,
    {
        ...
        let mut results = vec![<G as PrimeCurveAffine>::Curve::identity(); num_groups * num_windows];
        ...
        E: Engine,
{
            ...
            G::Engine: crate::pairing::Engine,
    {
        ...
        let results = crate::worker::THREAD_POOL.install(|| {
            if n > 0 {
                bases
                    .par_chunks(chunk_size)
                    .zip(exps.par_chunks(chunk_size))
                    .zip(self.kernels.par_iter_mut())
                    .map(|((bases, exps), kern)| -> Result<<G as PrimeCurveAffine>::Projective, GPUError> {
                        let mut acc = <G as PrimeCurveAffine>::Curve::identity();
        ...
        let cpu_acc = cpu_dense_multiexp(
            &pool,
